...
{
  if (_printDebug == true)
    _debugSerial->printf("%d", i);
}

void ICM_20948::debugPrintf(float f)
{
  if (_printDebug == true)
    _debugSerial->printf("%f", f);
}
...
void ICM_20948::debugPrintStatus(ICM_20948_Status_e stat)
{
    ...
    case ICM_20948_Stat_DMPNotSupported:
        debugPrint("DMP Firmware Not Supported. Is #define ICM_20948_USE_DMP commented in util/ICM_20948_C.h?");
        break;
...
ICM_20948_AGMT_t ICM_20948::getAGMT(bool get_settings)
{
    status = ICM_20948_get_agmt(&_device, &agmt, get_settings);

    return agmt;
}

ICM_20948_AGMT_t ICM_20948::getAG(bool get_settings)
{
    status = ICM_20948_get_ag(&_device, &agmt, get_settings);
...
uint8_t ICM_20948::i2cMasterSingleR(uint8_t addr, uint8_t reg)
{
    ...
    if (status != ICM_20948_Stat_Ok)
    {
        debugPrint("ICM_20948::i2cMasterSingleR: ICM_20948_i2c_master_single_r returned: ");
        debugPrintStatus(status);
        debugPrintln("");
    }
    return data;
...
ICM_20948_Status_e ICM_20948::startupDefault(bool minimal)
{
    ...
    if (retval != ICM_20948_Stat_Ok)
    {
        debugPrint("ICM_20948::startupDefault: startupMagnetometer returned: ");
        debugPrintStatus(retval);
        debugPrintln("");
        status = retval;
        return status;
...
ICM_20948_Status_e ICM_20948::enableDMPSensorInt(enum inv_icm20948_sensor sensor, bool enable)
{
  if (_device._dmp_firmware_available == true) // Should we attempt to enable the sensor interrupt?
  {
    ...
    debugPrint("ICM_20948::enableDMPSensorInt:  _enabled_Android_intr_0: ");
...
ICM_20948_Status_e ICM_20948_I2C::begin(I2C &i2c, bool ad0val, uint8_t ad0pin)
{
    // Associate
    _ad0 = ad0pin;
    _i2c = &i2c;
    ...
    {
        return ICM_20948_Status_e::ICM_20948_Stat_NotImpl;
//        DigitalOut pin(ad0pin);
//        pin = ad0val;
    }
...
ICM_20948_Status_e ICM_20948::startupMagnetometer(void)
{
    ...
    {
        debugPrint("ICM_20948::startupMagnetometer: reached MAX_MAGNETOMETER_STARTS (");
    ...
    {
      debugPrint("ICM_20948::startupMagnetometer: successful magWhoIAm after ");
...
ICM_20948_Status_e ICM_20948_write_I2C(uint8_t reg, uint8_t *data, uint32_t len, void *user)
{
    ...
    I2C *_i2c = ((ICM_20948_I2C *)user)->_i2c; // Cast user field to ICM_20948_I2C type and extract the I2C interface pointer
...
//    _I2CBuffer[0] = 0;
    ...
    int status = _i2c->write((int)addr<<1, (const char*)_I2CBuffer, len+1, false);

    if(status){
        ((ICM_20948_I2C *)user)->debugPrint("ICM_20948_write_I2C: i2c->write fails.");
...
ICM_20948_Status_e ICM_20948_read_I2C(uint8_t reg, uint8_t *buff, uint32_t len, void *user)
{
    ...
    I2C *_i2c = ((ICM_20948_I2C *)user)->_i2c;
    uint8_t addr = ((ICM_20948_I2C *)user)->_addr;
    if (_i2c == NULL)
    {
        return ICM_20948_Stat_ParamErr;
...
//    _I2CBuffer[0] = 0;
    _I2CBuffer[0] = reg;
    int status = _i2c->write((int)addr<<1, (const char*)_I2CBuffer, 1, true);
    if(status){
        ((ICM_20948_I2C *)user)->debugPrint("ICM_20948_read_I2C: i2c->write fails.");
        return ICM_20948_Stat_Err;
    }
 
    status = _i2c->read((int)addr<<1|0x01, (char*)buff, len, false);
    
    if(status){
        ((ICM_20948_I2C *)user)->debugPrint("ICM_20948_read_I2C: i2c->read fails.");
       return ICM_20948_Stat_Err;
    }
    return ICM_20948_Stat_Ok;
}
