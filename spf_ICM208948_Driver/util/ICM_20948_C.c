...
// retval = ICM_20948_execute_r(pdev, AGB0_REG_INT_STATUS_1, (uint8_t *)&reg, sizeof(ICM_20948_INT_STATUS_1_t));  // regを扱うのがここだけ  // これで呼ぶ
...
// Higher Level
ICM_20948_Status_e ICM_20948_get_agmt(ICM_20948_Device_t *pdev, ICM_20948_AGMT_t *pagmt, bool get_settings)
{
	if (pagmt == NULL)
	{
		return ICM_20948_Stat_ParamErr;
...
ICM_20948_Status_e ICM_20948_get_ag(ICM_20948_Device_t *pdev, ICM_20948_AGMT_t *pagmt, bool get_settings)
{
	if (pagmt == NULL)
	{
		return ICM_20948_Stat_ParamErr;
	...
	ICM_20948_Status_e retval = ICM_20948_Stat_Ok;
	const uint8_t numbytes = 12; //Read Accel and gyro;
	uint8_t buff[numbytes];
